...
const Partners = () => {
  ...
  return (
    <section className="partners-section">
      <p className="partners-label">Trusted by organizations across India</p>
      <div className="partners-track-wrapper">
        <div className="partners-track">
          {items.map((brand, i) => (
            <span className="partners-brand" key={i}>
              <span className="partners-logo">{brand.logo}</span>
              {brand.name}
            </span>
          ))}
        </div>
